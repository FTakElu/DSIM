    ...
    <div className={styles.card}>
      ...
      <div className={styles.deviceStatus}>
        <div className={styles.statusItem}>
          <FaWifi
            color={
              patient.statusDispositivo === "online" ? "#4caf50" : "#9e9e9e"
            }
          />
          <span>
            {patient.statusDispositivo === "online" ? "Online" : "Offline"}
          </span>
        </div>
      ...
      <div className={styles.vitals}>
        <div className={styles.vitalItem}>
          <div
            className={`${styles.vitalIcon} ${
              styles[getStatusClassName(oxygenStatus)]
            }`}
          >
            <FaTint />
          </div>
        ...
        <div className={styles.vitalItem}>
          <div
            className={`${styles.vitalIcon} ${
              styles[getStatusClassName(tempStatus)]
            }`}
          >
            <FaThermometerHalf />
          </div>
        ...
        <div className={styles.vitalItem}>
          <div
            className={`${styles.vitalIcon} ${
              styles[getStatusClassName(heartStatus)]
            }`}
          >
            <FaHeartbeat />
          </div>
